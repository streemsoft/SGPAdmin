...
import app.streem.sgpadmin.Adapter.DespesaAdapter;
...
public class ConsultaDespesaActivity extends AppCompatActivity {
    ...
    private List<Lancamento> lista_despesas;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_consulta_despesa);
        ...
        valor = findViewById(R.id.consultadespesatotal);
        botaobuscar = findViewById(R.id.consultacaixabotaobuscar);
        preferencias = new Preferencias(this);
        lista_despesas = new ArrayList<>();
        progressBar = findViewById(R.id.consultadespesaprogressBar);
        semregistro = findViewById(R.id.consultadespesasemregistro);
        ...
        entrada.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                dataPickerEntrada = new DatePickerDialog(ConsultaDespesaActivity.this, dateEntrada, myCalendarEntrada
        ...
        saida.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                dataPickerSaida = new DatePickerDialog(ConsultaDespesaActivity.this, dateSaida, myCalendarSaida
        ...
        adapter = new DespesaAdapter(lista_despesas, this);
        ...
        botaobuscar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(entrada.getText().toString().equals("") | saida.getText().toString().equals("Selecionar")){
                    Toast.makeText(ConsultaDespesaActivity.this, "Selecione as datas!",Toast.LENGTH_SHORT).show();
                }else {
                    getFirebase();
                }
            }
    ...
    public void getFirebase(){
        ...
        Firebase.getDatabaseReference().child(preferencias.getCHAVE_KEY_POSTO_ATIVO()).child("DESPESAS").orderByChild("datacad").startAt(inicio).endAt(fim).addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                for(DataSnapshot dados : dataSnapshot.getChildren()){
                    Lancamento preco = dados.getValue(Lancamento.class);
    ...
    public void calcularTotal(){
        ...
        for(Lancamento c : lista_despesas){
